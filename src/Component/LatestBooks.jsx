...
export default function LatestBooks({ eachbook }) {
    return (
        <div className="bg-white shadow-md rounded-2xl overflow-hidden hover:shadow-2xl hover:-translate-y-2 transform transition-all duration-300 border border-gray-100">
            <div className="relative">
                <img
                    src={eachbook.coverImage}
                    alt={eachbook.title}
                    className="w-full h-74 object-cover rounded-t-2xl"
                />
